...
import com.lti.itops.ipac.custcatmgmt.service.TowerCustomerMapLocalService;
...
/**
 * Provides the base implementation for the tower customer map local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.lti.itops.ipac.custcatmgmt.service.impl.TowerCustomerMapLocalServiceImpl}.
 * </p>
 *
 * @author sunprabh
 ...
 */
@ProviderType
public abstract class TowerCustomerMapLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TowerCustomerMapLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.lti.itops.ipac.custcatmgmt.service.TowerCustomerMapLocalServiceUtil} to access the tower customer map local service.
	 */
	...
	public TowerCustomerMap addTowerCustomerMap(
		...
		return towerCustomerMapPersistence.update(towerCustomerMap);
	}
	...
	public TowerCustomerMap createTowerCustomerMap(long towerCustomerId) {
		return towerCustomerMapPersistence.create(towerCustomerId);
	}
	...
	public TowerCustomerMap deleteTowerCustomerMap(long towerCustomerId)
		...
		return towerCustomerMapPersistence.remove(towerCustomerId);
	}
	...
	public TowerCustomerMap deleteTowerCustomerMap(
		TowerCustomerMap towerCustomerMap) {
		return towerCustomerMapPersistence.remove(towerCustomerMap);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TowerCustomerMap.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return towerCustomerMapPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return towerCustomerMapPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public TowerCustomerMap fetchTowerCustomerMap(long towerCustomerId) {
		return towerCustomerMapPersistence.fetchByPrimaryKey(towerCustomerId);
	}
	...
	public TowerCustomerMap getTowerCustomerMap(long towerCustomerId)
		throws PortalException {
		return towerCustomerMapPersistence.findByPrimaryKey(towerCustomerId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(towerCustomerMapLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TowerCustomerMap.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("towerCustomerId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(towerCustomerMapLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TowerCustomerMap.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return towerCustomerMapLocalService.deleteTowerCustomerMap((TowerCustomerMap)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return towerCustomerMapPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TowerCustomerMap> getTowerCustomerMaps(int start, int end) {
		return towerCustomerMapPersistence.findAll(start, end);
	}
	...
	public int getTowerCustomerMapsCount() {
		return towerCustomerMapPersistence.countAll();
	}
	 ...
	 */
	public TowerCustomerMapLocalService getTowerCustomerMapLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.lti.itops.ipac.custcatmgmt.model.TowerCustomerMap",
			towerCustomerMapLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.lti.itops.ipac.custcatmgmt.model.TowerCustomerMap");
	}
	...
	public String getOSGiServiceIdentifier() {
		return TowerCustomerMapLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = towerCustomerMapPersistence.getDataSource();
	...
	@BeanReference(type = TowerCustomerMapLocalService.class)
	protected TowerCustomerMapLocalService towerCustomerMapLocalService;
