...
/**
 * The base model interface for the TowerCustomerMap service. Represents a row in the &quot;IPAC_CUST_CAT_MGMT_TowerCustomerMap&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.lti.itops.ipac.custcatmgmt.model.impl.TowerCustomerMapModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.lti.itops.ipac.custcatmgmt.model.impl.TowerCustomerMapImpl}.
 * </p>
 *
 * @author sunprabh
 ...
 */
@ProviderType
public interface TowerCustomerMapModel extends BaseModel<TowerCustomerMap>,
	LocalizedModel, ShardedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a tower customer map model instance should use the {@link TowerCustomerMap} interface instead.
	 */
