...
/**
 * Provides the local service interface for TTDeliverableCustomerMap. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author sunprabh
 * @see TTDeliverableCustomerMapLocalServiceUtil
...
public interface TTDeliverableCustomerMapLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TTDeliverableCustomerMapLocalServiceUtil} to access the tt deliverable customer map local service. Add custom service methods to {@link com.lti.itops.ipac.custcatmgmt.service.impl.TTDeliverableCustomerMapLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public TTDeliverableCustomerMap addTTDeliverableCustomerMap(
		TTDeliverableCustomerMap ttDeliverableCustomerMap);

	public boolean addTTDeliverableCustomerMapping(long TTDeliverableId,
		long organizationId, Map<Locale, String> name, long companyId,
		long createdBy, int statusId) throws SystemException, PortalException;
	...
	*/
	...
	public TTDeliverableCustomerMap createTTDeliverableCustomerMap(
	...
	*/
	...
	public TTDeliverableCustomerMap deleteTTDeliverableCustomerMap(
		long TTDeliverableCustomerId) throws PortalException;
	...
	*/
	...
	public TTDeliverableCustomerMap editTTDeliverableCustomerMapping(
		long TTDeliverableCustomerId, Map<Locale, String> name,
		long modifiedBy, int statusId) throws PortalException, SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TTDeliverableCustomerMap fetchTTDeliverableCustomerMap(
		long TTDeliverableCustomerId);

	public List<TTDeliverableCustomerMap> findActiveTTDeliverableCustomerMap(
		List<Long> tTDeliverableIds, long organizationId)
	...
	public List<TTDeliverableCustomerMap> findTTDeliverableCustomerMap(
		List<Long> tTDeliverableIds, long organizationId)
		throws SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TTDeliverableCustomerMap getTTDeliverableCustomerMap(
		long TTDeliverableCustomerId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TTDeliverableCustomerMap> getTTDeliverableCustomerMaps(
		int start, int end);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Long> getUniqueTTDIDsByTTIDList(List<Organization> projects,
		List<Long> tTechnologyIds) throws SystemException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public TTDeliverableCustomerMap updateTTDeliverableCustomerMap(
		TTDeliverableCustomerMap ttDeliverableCustomerMap);

	public TTDeliverableCustomerMap updateTTDeliverableCustomerMapping(
